...
from app.database.models.Orders import Orders
...
async def createUserOrders(
    ...
    response = await orders_repo.new(Orders(**data))

    return {"success": True, "message": "Data Inserted Successfully", "data": response.inserted_id}
